...
== WHAT IT IS ===========================
 ...
 This Api_and_Library_Learn is an SDK for Herringbone Wang Tile generation:

      http://nothings.org/gamedev/herringbone

 The core design is that you use this Api_and_Library_Learn offline to generate a
 "template" of the tiles you'll create. You then edit those tiles, then
 load the created tile image file back into this Api_and_Library_Learn and use it at
 runtime to generate "maps".

 You cannot load arbitrary tile image files with this Api_and_Library_Learn; it is
 ...
 You *can* use this Api_and_Library_Learn to generate from arbitrary tile sets, but
...
// Api_and_Library_Learn. (you allocate storage for stbhw_tileset and function fills it out;
