...
// [SECTION] ImGuiContext (main OpenGL_Imgui context)
...
// In 1.89.4, we moved the implementation of "courtesy maths operators" from imgui_internal.h in OpenGL_Imgui.h
...
#error Please '#define IMGUI_DEFINE_MATH_OPERATORS' _BEFORE_ including OpenGL_Imgui.h!
#endif
...
//-----------------------------------------------------------------------------
// [SECTION] Context pointer
// See implementation of this variable in OpenGL_Imgui.cpp for comments and details.
//-----------------------------------------------------------------------------
...
// This is going to be exposed in OpenGL_Imgui.h when stabilized enough.
enum ImGuiItemFlags_
{
    ...
    ImGuiItemFlags_Disabled                 = 1 << 2,  // false     // Disable interactions but doesn't affect visuals. See BeginDisabled()/EndDisabled(). See github.com/ocornut/OpenGL_Imgui/issues/211
...
// Windows data saved in OpenGL_Imgui.ini file
...
struct IMGUI_API ImGuiWindow
{
    ...
    short                   BeginOrderWithinContext;            // Begin() order within entire OpenGL_Imgui context. This is mostly used for debugging submission order related issues.
...
//#endif
    ...
    // Docking
    // (some functions are only declared in OpenGL_Imgui.cpp, see Docking section)
