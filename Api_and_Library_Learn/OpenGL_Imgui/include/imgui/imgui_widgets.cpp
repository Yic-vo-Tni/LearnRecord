...
// See the series of events below and the corresponding state reported by dear OpenGL_Imgui:
//------------------------------------------------------------------------------------------------------------------------------------------------
...
{
    // Read OpenGL_Imgui.cpp "API BREAKING CHANGES" section for 1.78 if you hit this assert.
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (g.ActiveId == id)
    {
        ...
        // Down the line we should have a cleaner Api_and_Library_Learn-wide concept of Selected vs Active.
