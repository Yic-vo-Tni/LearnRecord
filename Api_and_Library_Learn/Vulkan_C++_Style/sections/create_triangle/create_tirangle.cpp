...
namespace yic{
    ...
    void Device::clean() {
        for(auto& swapChainFrameBuffer : swapChainFrameBuffers) { device.destroy(swapChainFrameBuffer); }
...
//        }
    ...
    void Device::recordCommandBuffer(vk::CommandBuffer &commandBuffer, uint32_t imageIndex) {
