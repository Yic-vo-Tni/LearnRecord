...
namespace yic{
    ...
    private:
        ...
        Shader shader{R"(F:\Program\LearningRecord\Api_and_Library_Learn\OpenGL_Imgui\src\shader\shader.vert)", R"(F:\Program\LearningRecord\Api_and_Library_Learn\OpenGL_Imgui\src\shader\shader.frag)"};
